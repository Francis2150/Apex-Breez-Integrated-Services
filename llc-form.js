 (function() {
        ...
        var secFromDir = -1; // -1 = manual secretary, >=0 = index of linked director
        ...
        function handleSubCheck(dirIdx, isChecked) {
            ...
            if (!isChecked) {
                // Clear share percent when unchecked
        ...
        function save() {
            ...
            // Save all static fields (company info, office details)
        ...
        function attachListeners() {
            ...
            // Static fields (company info, office details, secretary)
            document.querySelectorAll('.static-field').forEach(function(inp) {
...
document.getElementById('llcForm').addEventListener('submit', function(e) {
    ...
    // Check share total if any shares are allocated
